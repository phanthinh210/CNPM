<?php
	...
	{
	$sql= "select * from sanpham order by giatien desc limit ".$start.",".$limit;
	}	
	else if (isset($_GET['idtanggia']))
	{
	$sql= "select * from sanpham order by giatien asc limit ".$start.",".$limit;
	}	
	else{
